 ...
 *       &lt;sequence>
 *         &lt;element name="RfrdDocInf" type="{urn:iso:std:iso:20022:tech:xsd:RTC.G2N.054.01}ReferredDocumentInformation3" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="RfrdDocInf2" type="{urn:iso:std:iso:20022:tech:xsd:RTC.G2N.054.01}ReferredDocumentInformation3" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="RfrdDocAmt" type="{urn:iso:std:iso:20022:tech:xsd:RTC.G2N.054.01}RemittanceAmount1" minOccurs="0"/>
 *         &lt;element name="CdtrRefInf" type="{urn:iso:std:iso:20022:tech:xsd:RTC.G2N.054.01}CreditorReferenceInformation2" minOccurs="0"/>
 *         &lt;element name="Invcr" type="{urn:iso:std:iso:20022:tech:xsd:RTC.G2N.054.01}PartyIdentification32" minOccurs="0"/>
 *         &lt;element name="Invcee" type="{urn:iso:std:iso:20022:tech:xsd:RTC.G2N.054.01}PartyIdentification32" minOccurs="0"/>
 *         &lt;element name="AddtlRmtInf" type="{urn:iso:std:iso:20022:tech:xsd:RTC.G2N.054.01}Max140Text" maxOccurs="3" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class StructuredRemittanceInformation7 {
    ...
    @XmlElement(name = "RfrdDocInf2")
    protected List<ReferredDocumentInformation3> rfrdDocInf2;
    ...
    /**
     * Gets the value of the rfrdDocInf2 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     ...
     * 
     */
    public List<ReferredDocumentInformation3> getRfrdDocInf2() {
        if (rfrdDocInf2 == null) {
            rfrdDocInf2 = new ArrayList<ReferredDocumentInformation3>();
        }
        return this.rfrdDocInf2;
    }
