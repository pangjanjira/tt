 ...
 * @author s60982
 */
@WebServlet(name = "RequestReviewRequestControl", urlPatterns = {"/RequestReviewRequestControl"})
public class RequestReviewRequestControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (action.equals("InquiryReview")) { //Inquiry the pending List
                ...
                //String gpGuaStr = new Gson().toJson(rs.inquiryReview(taxId, accountNo, expireDateFrom, expireDateTo));
                //String gpGuaStr = new Gson().toJson(rs.inquiryReview(taxId, accountNo, expireDateFrom, expireDateTo, egpStatus)); //add by Malinee T. UR58100048 @20151224
                String gpGuaStr = new Gson().toJson(rs.inquiryReview(taxId, accountNo, expireDateFrom, expireDateTo, egpStatus, requestType)); //UR58120031 add by Tana L. @15022016
...
//                out.print(parentId);
                ...
                RequestService rs = new RequestService();
                //String fileName = rs.inquiryReviewForExportExcel(taxId, accountNo, expireDateFrom, expireDateTo, username);
                //String fileName = rs.inquiryReviewForExportExcel(taxId, accountNo, expireDateFrom, expireDateTo, egpStatus, username); //update by Malinee T. UR58100048 @20151224 
                String fileName = rs.inquiryReviewForExportExcel(taxId, accountNo, expireDateFrom, expireDateTo, egpStatus, requestType, username); //UR58120031 add by Tana L. @15022016
