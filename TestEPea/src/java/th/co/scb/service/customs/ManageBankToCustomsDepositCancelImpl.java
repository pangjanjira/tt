...
import th.co.scb.model.customs.g1c054.AccountIdentification4Choice;
import th.co.scb.model.customs.g1c054.AccountNotification2;
import th.co.scb.model.customs.g1c054.ActiveOrHistoricCurrencyAndAmount;
import th.co.scb.model.customs.g1c054.AmountAndCurrencyExchange3;
import th.co.scb.model.customs.g1c054.AmountAndCurrencyExchangeDetails3;
import th.co.scb.model.customs.g1c054.BankToCustomerDebitCreditNotificationV02;
import th.co.scb.model.customs.g1c054.BankTransactionCodeStructure4;
import th.co.scb.model.customs.g1c054.BranchAndFinancialInstitutionIdentification4;
import th.co.scb.model.customs.g1c054.BranchData2;
import th.co.scb.model.customs.g1c054.CashAccount16;
import th.co.scb.model.customs.g1c054.CashAccount20;
import th.co.scb.model.customs.g1c054.CreditDebitCode;
import th.co.scb.model.customs.g1c054.DateAndDateTimeChoice;
import th.co.scb.model.customs.g1c054.EntryDetails1;
import th.co.scb.model.customs.g1c054.EntryStatus2Code;
import th.co.scb.model.customs.g1c054.EntryTransaction2;
import th.co.scb.model.customs.g1c054.FinancialInstitutionIdentification7;
import th.co.scb.model.customs.g1c054.GenericAccountIdentification1;
import th.co.scb.model.customs.g1c054.GenericFinancialIdentification1;
import th.co.scb.model.customs.g1c054.GenericOrganisationIdentification1;
import th.co.scb.model.customs.g1c054.GroupHeader42;
import th.co.scb.model.customs.g1c054.ObjectFactory;
import th.co.scb.model.customs.g1c054.OrganisationIdentification4;
import th.co.scb.model.customs.g1c054.OrganisationIdentificationSchemeName1Choice;
import th.co.scb.model.customs.g1c054.Party6Choice;
import th.co.scb.model.customs.g1c054.PartyIdentification32;
import th.co.scb.model.customs.g1c054.ProprietaryBankTransactionCodeStructure1;
import th.co.scb.model.customs.g1c054.ReferredDocumentInformation3;
import th.co.scb.model.customs.g1c054.ReferredDocumentType1Choice;
import th.co.scb.model.customs.g1c054.ReferredDocumentType2;
import th.co.scb.model.customs.g1c054.RemittanceInformation5;
import th.co.scb.model.customs.g1c054.ReportEntry2;
import th.co.scb.model.customs.g1c054.ReturnReason5Choice;
import th.co.scb.model.customs.g1c054.ReturnReasonInformation10;
import th.co.scb.model.customs.g1c054.StructuredRemittanceInformation7;
import th.co.scb.model.customs.g1c054.TransactionAgents2;
import th.co.scb.model.customs.g1c054.TransactionDates2;
import th.co.scb.model.customs.g1c054.TransactionParty2;
import th.co.scb.model.customs.g1c054.TransactionReferences2;
 ...
 *
 */
public class ManageBankToCustomsDepositCancelImpl implements ManageBankToCustomsDepositCancel {

	/* (non-Javadoc)
	 * @see th.co.scb.service.customs.ManageBankToCustomsDepositCancel#createDocument()
	 */
	...
	private TransactionReferences2 createTransactionReferences2(ObjectFactory factory, EGuarantee eguarantee){
		...
		tr.setMsgId(Constants.Customs.DOC_RETURN_G1C);//name of return
	...
	private StructuredRemittanceInformation7 createStructuredRemittanceInformation7(ObjectFactory factory, EGuarantee eguarantee){
		...
		referDocInfoList.add(createReferredDocumentInformation3(factory, Constants.Customs.DECLARATION_SEQ, eguarantee));
	...
	private ReferredDocumentInformation3 createReferredDocumentInformation3(ObjectFactory factory, int type, EGuarantee eguarantee){
		...
		}else if(type == Constants.Customs.DECLARATION_SEQ){
			rdi.setNb(eguarantee.getDeclarationSeqNo());//Declaration Seq No
	...
	private ReferredDocumentType1Choice createReferredDocumentType1Choice(ObjectFactory factory, int type, EGuarantee eguarantee){
		...
		if(type == Constants.Customs.DECLARATION_NO){
			...
			rdt.setPrtry(Constants.Customs.DECLARATION_SEQ_NO_TEXT);//Declaration Seq No
		}else if(type == Constants.Customs.BANK_GUARANTEE_NO){
