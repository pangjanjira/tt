        ...
        <div id="wrap">
            ...
            <div id="content">
                ...
                <div class="inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                        	<!-- //UR58120031 Edit Request Approval Icon by Tana L. @15022016 -->
                            <h3 style="color:#666666;"> <i class=" icon-edit-sign"></i> Request Approval </h3>
                            <h4>SETUP / EXTEND EXPIRY DATE Request Approval</h4>
                        </div>
                    </div>
                    <hr />
                    <!-- END PAGE TITLE -->
                                    ...
                                    <div class="modal-body">
                                        <form role="form" class="form-horizontal" id="approveForm">
                                            ...
                                            <div class="alert alert-info" id="approveActionForm">
                                                ...
                                                <input type="hidden" id="iApprovalBy" name="iApprovalBy" value=""/>
                                                <div class="form-group">
...
<!--                                                            <option value="">-- ALS Account --</option>-->
                                                        ...
                                                        <input type="hidden" id="iReviewAccount" name="iReviewAccount"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-lg-3">Approve/Reject</label>
                                                    <div class="col-lg-9">
                                                        <select name="iApprovalStatus" id="iApprovalStatus" class="form-control">
                                                            <option value="RJ">Rejected</option>
                                                            <option value="AP">Approved</option>
                                                        </select>
                                                        <input type="hidden" id="iReviewStatus" name="iReviewStatus"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-lg-3">Reason</label>
                                                    <div class="col-lg-9">
                                                        <textarea id="iApprovalReason" name="iApprovalReason" class="form-control" rows="3" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-actions no-margin-bottom col-lg-12" style="text-align:center;">
...
<!--                            &nbsp;&nbsp;&nbsp;<button type="button" id="refreshMonitorListBtn" class="btn btn-info btn-circle"><i class="icon-refresh"></i></button>-->
        ...
        <script src="assets/js/requestMonitor.js"></script>
