        ...
        <div id="wrap">
            ...
            <div id="content">
                ...
                <div class="inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 style="color:#666666;"> <i class=" icon-search"></i> Decrease Amount During Year </h3>
                        </div>
                    </div>
                    <hr />
                    <!-- END PAGE TITLE -->
                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            <header>
                                ...
                                <h5>Decrease Amount During Year</h5>
                                <div class="toolbar">
                                    <ul class="nav">
                                        <li>
                                            <div class="btn-group">
                            ...
                            <div id="inquiryFormBox" class="accordion-body collapse in body">
                                ...
                                <form action="#" class="form-horizontal" id="block-validate">
                                    <h4>LG To Be Cancel</h4>
                                    <div class="form-group">
                                        <div class="col-lg-1">&nbsp;</div>
                                        <label id="lg" class="control-label col-lg-2">LG No.<font color="red" size="4"> *</font></label>
                                        <div class="col-lg-3">
                                            <input type="text" id="LgNo" name="LG No." class="form-control" />
                                        </div>
                                        <p id="blank6"></p>
                                        <div class="col-lg-1">&nbsp;</div>
                                    </div>
                ...
                <script>
                    function myFunction() {
                        ...
                        var lg = document.getElementById("LgNo").value;
                        ...
                        } else if (ca != "" && secureNo != "" && bpNo != "" && taxId != "" && amount != "" && lg != "" && guarantee != "" && accountNo != "" && startDate != "" && endDate != "" && mailValid == "1") {
